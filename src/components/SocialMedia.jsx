...
function LinkedinIcon(props) {
  return (
    <svg viewBox='0 0 24 24' {...props}>
      <path
        d='M18,3H6C4.3,3,3,4.3,3,6v12c0,1.7,1.3,3,3,3h12c1.7,0,3-1.3,3-3V6C21,4.3,19.7,3,18,3z M9,17.6H7.1v-7.5H9V17.6z M9,8.6
	C8.8,8.9,8.5,9,8.1,9C7.7,9,7.4,8.9,7.1,8.6S6.8,8,6.8,7.7c0-0.4,0.1-0.7,0.4-0.9c0.2-0.2,0.6-0.4,0.9-0.4c0.4,0,0.7,0.1,0.9,0.4
	C9.3,7,9.4,7.3,9.4,7.7C9.4,8.1,9.3,8.4,9,8.6z M17.6,17.6h-1.9v-4.2c0-1.2-0.7-1.8-1.5-1.8c-0.4,0-0.9,0.2-1.1,0.6
	c-0.3,0.3-0.4,0.7-0.4,1.2v4.3h-1.9v-7.5h1.9v1.2h0c0.6-0.9,1.4-1.4,2.4-1.4c1.5,0,2.4,1.1,2.4,3.1V17.6z'
      />
    </svg>
  );
}
...
export const socialMediaProfiles = [
  ...
  {
    title: 'Linkedin',
    href: 'https://www.linkedin.com/in/gianlucaxstrada/',
    icon: LinkedinIcon,
  },
];
